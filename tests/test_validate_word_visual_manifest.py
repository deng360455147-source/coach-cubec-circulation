...
def production_manifest() -> dict:
    ...
    data["pages"][0]["visuals"][0]["internal_text_size_pt"] = 14
    data["pages"][0]["visuals"][0]["key_label_text_size_pt"] = 16
    return data
...
class WordVisualManifestTests(unittest.TestCase):
    ...
    def test_figure_table_toc_and_pagination_drift_fail(self) -> None:
        ...
        visual["internal_text_size_pt"] = 12
        visual["key_label_text_size_pt"] = 14
        ...
        self.assertIn("key_label_text_size_pt", errors)
